...
export default function CampaignWorkPage() {
  ...
  const handleStatusUpdate = (status: string) => {
    ...
    updateStatusMutation.mutate({
      id: selectedLeadId,
      status,
      category: "ACTIVE", // Auto-update to ACTIVE on status change
    });
  };
  ...
  return (
    <div className="bg-background flex h-screen flex-col overflow-scroll">
      ...
      <div className="flex flex-1 overflow-scroll">
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div
              className={cn(
                "hidden flex-1 flex-col overflow-hidden md:flex",
                viewMode === "details" && window.innerWidth < 768 ? "flex" : "",
              )}
            >
              {selectedLead ? (
                <>
